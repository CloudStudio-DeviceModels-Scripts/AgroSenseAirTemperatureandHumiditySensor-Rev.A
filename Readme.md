...
# Parsing + Configuration Script – AgroSense Air Temperature and Humidity Sensor - Rev. A

This **Parsing + Configuration** script is designed for the **AgroSense Air Temperature and Humidity Sensor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AgroSense Air Temperature and Humidity Sensor Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AgroSense Air Temperature and Humidity Sensor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
